...
export default function SoftwareHero({ content, onProjects, onResumeDownload }) {
              ...
              <div className="space-y-8">
                ...
                <div className="flex flex-wrap gap-4">
                  <button
                    type="button"
                    onClick={onProjects}
                    className="rounded-full bg-gradient-to-r from-fuchsia-500 to-cyan-400 px-6 py-3.5 text-sm font-semibold text-white shadow-lg shadow-fuchsia-500/20 transition hover:-translate-y-0.5"
                  >
                    View Projects
                  </button>
                  <button
                    ...
                    className="rounded-full border border-white/10 bg-white/5 px-6 py-3.5 text-sm font-semibold text-white/85 transition hover:-translate-y-0.5 hover:bg-white/10"
                  >
                    Download Resume
                  </button>
                </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="mt-2 font-display text-2xl font-semibold text-white">
                          {content.liveStackTitle}
                        </p>
                      </div>
                      <div className="rounded-2xl border border-white/10 bg-white/5 px-3 py-2 text-xs font-semibold tracking-[0.25em] text-cyan-200">
                        {content.liveStackStatus}
                      </div>
                    </div>
